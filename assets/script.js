...
var options002 = [
  "<button class=buttons001 onclick=q2c()>False</button><br /><br /><button class=buttons001 onclick=q2i()>True</button>",
];
var options003 = [
  "<button class=buttons001 onclick=q3c()>True</button><br /><br /><button class=buttons001 onclick=q3i()>False</button>",
];
var options004 = [
  "<button class=buttons001 onclick=q4i()>True</button><br /><br /><button class=buttons001 onclick=q4c()>False</button>",
];
var options005 = [
  "<button class=buttons001 onclick=q5c()>False</button><br /><br /><button class=buttons001 onclick=q5i()>True</button>",
];
var options006 = [
  "<button class=buttons001 onclick=q6i()>False</button><br /><br /><button class=buttons001 onclick=q6c()>True</button>",
];
var options007 = [
  "<button class=buttons001 onclick=q7c()>True</button><br /><br /><button class=buttons001 onclick=q7i()>False</button>",
];
var options008 = [
  "<button class=buttons001 onclick=q8c()>False</button><br /><br /><button class=buttons001 onclick=q8i()>True</button>",
];
var options009 = [
  "<button class=buttons001 onclick=q9c()>True</button><br /><br /><button class=buttons001 onclick=q9i()>False</button>",
];
var options010 = [
  "<button class=buttons001 onclick=q10i()>True</button><br /><br /><button class=buttons001 onclick=q10c()>False</button>",
];
...
function q5c() {
  ...
  message003.innerHTML =
    "Correct. The blue whale feeds on small shrimp-like fish called Krills.";
  message002.innerHTML = "";
  score001.innerHTML = b++;
  message004.innerHTML =
    "<button class=buttons002 onclick=next001()>Next</button>";
...
function q5i() {
  ...
  c = "-";
  message003.innerHTML =
    "Incorrect. The Blue Whale feeds on small shrimp-like fish called Krills.";
  message002.innerHTML = "";
  message004.innerHTML =
    "<button class=buttons002 onclick=next001()>Next</button>";
}
...
function q6i() {
  ...
  c = "-";
  message003.innerHTML =
    "Incorrect. Fifa World Cup tournaments are played every 4 years.";
  message002.innerHTML = "";
  message004.innerHTML =
    "<button class=buttons002 onclick=next001()>Next</button>";
}
...
function q7i() {
  ...
  c = "-";
  message003.innerHTML =
    "Incorrect. More countries on the north side than there are on the south side.";
  message002.innerHTML = "";
  message004.innerHTML =
    "<button class=buttons002 onclick=next001()>Next</button>";
}
...
function q8c() {
  ...
  c = "-";
  message003.innerHTML =
    "Correct. Greenland is the largest island in the world.";
  message002.innerHTML = "";
  score001.innerHTML = b++;
  message004.innerHTML =
    "<button class=buttons002 onclick=next001()>Next</button>";
...
function q8i() {
  ...
  c = "-";
  message003.innerHTML =
    "Incorrect. Greenland is the largest island in the world.";
  message002.innerHTML = "";
  message004.innerHTML =
    "<button class=buttons002 onclick=next001()>Next</button>";
}
...
function q9i() {
  ...
  c = "-";
  message003.innerHTML =
    "Incorrect. Helium is the lightest gas of all gas elements.";
  message002.innerHTML = "";
  message004.innerHTML =
    "<button class=buttons002 onclick=next001()>Next</button>";
}
...
function q10c() {
  ...
  c = "-";
  message003.innerHTML =
    "Correct. Venus is the hottest planet. That is because its atmosphere contains 95% of Carbon dioxide.";
  message002.innerHTML = "";
  score001.innerHTML = b++;
  message004.innerHTML =
    "<button class=buttons002 onclick=next001()>Next</button>";
...
function q10i() {
  ...
  c = "-";
  message003.innerHTML =
    "Incorrect. Venus is the hottest planet. That is because its atmosphere contains 95% of Carbon dioxide.";
  message002.innerHTML = "";
  message004.innerHTML =
    "<button class=buttons002 onclick=next001()>Next</button>";
}
